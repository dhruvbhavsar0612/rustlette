...
from rustlette.types import Scope
...
def collapse_excgroups() -> Generator[None, None, None]:
    try:
        ...
        if has_exceptiongroups:  # pragma: no cover
            while isinstance(exc, BaseExceptionGroup) and len(exc.exceptions) == 1:  # type: ignore[union-attr]
                exc = exc.exceptions[0]  # type: ignore[union-attr]
